...
if(isset($_POST['submit'])) {
    ...
    $password = $_POST['password'];
     //print_r($regno);
     $sql = "INSERT INTO manager (name,email,phone,location,username,password) VALUES ('$name','$email',' $phone','$location','$username','$password')"; 
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
				...
				<ul class="menu">
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item active" href="admin_add_manager.php">Add Manager</a>
...
<!-- //inner banner -->
	...
	<div class="container">
        ...
        <div class="col-6">
            <form action="admin_add_manager.php" method="post">
