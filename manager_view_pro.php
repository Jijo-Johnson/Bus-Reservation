        ...
        <div class="col-6">
            <form action="#" method="post">
                <div class="form-group">
                    <input type="text" name="name" class="form-control" required="" readonly value="<?php echo $result['name']; ?>">
                </div>
                <div class="form-group">
                    <input type="email" name="email" class="form-control" required="" readonly value="<?php echo $result['email']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="phone" class="form-control" required="" readonly value="<?php echo $result['phone']; ?>">
                </div>
                <div class="form-group">
                    <input name="location" class="form-control" type="text"  required="" readonly value="<?php echo $result['location']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="username" class="form-control" required="" readonly value="<?php echo $result['username']; ?>">
                </div>
