        ...
        <div class="col-6">
            <form action="#" method="post">
                <div class="form-group">
                    <input type="text" name="Name" class="form-control" placeholder="Full Name" required="" readonly>
                </div>
                <div class="form-group">
                    <input type="email" name="Email" class="form-control" placeholder="Email Id" required="" readonly>
                </div>
                <div class="form-group">
                    <input type="text" name="phone" class="form-control" placeholder="Phone Number" required="" readonly>
                </div>
                <div class="form-group">
                    <textarea name="Message" placeholder="Location" required="" readonly></textarea>
                </div>
                <div class="form-group">
                    <input type="text" name="Name" class="form-control" placeholder="Username" required="" readonly>
                </div>
                <div class="form-group">
                    <input type="password" name="Name" class="form-control" placeholder="Password" required="" readonly>
                </div>
