...
<div class="container">
    <div class="row justify-content-center">
		...
		<form action="#" method="post">
                ...
                <div class="form-group">
                    <input type="email" name="Email" class="form-control" placeholder="Route" required="" >
                </div>
                <div class="form-group">
                    <input type="text" name="phone" class="form-control" placeholder="Duration" required="">
                </div>              
                <div class="form-group">
                    <input type="text" name="Name" class="form-control" placeholder="Source" required="">
                </div>
				<div class="form-group">
				...
				<button type="button" class="btn btn-success mt-4">Edit</button>
