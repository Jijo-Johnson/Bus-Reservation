...
<section class="inner-banner text-center">
	<div class="container">
       ...
       <input type="text" value="Bus-13" id="bus">
    <div id="holder"> 
        <ul  id="place">
        </ul>    
    </div>
    ...
    <ul id="seatDescription">
        ...
        <input type="button" id="btnShowNew" value="View and Book Seats" />
        <!-- <input type="button" id="btnShow" value="Show Booked" />            -->
        </div>
	</div>
</section>
...
$('#btnShowNew').click(function () {
	...
	var bus=$("#bus").val();
	alert(bus)
	// alert("seat_action.php?seat="+seatno+"&bus="+bus);
	$.getJSON("seat_action.php?seat="+seatno+"&bus="+bus,function(json)
        							{
										var msg=json[0].msg;
										alert(msg);
									});
