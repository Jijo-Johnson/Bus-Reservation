        ...
        <div class="col-6">
            <form action="#" method="post">
                <div class="form-group">
                    <input type="date" name="Name" class="form-control" placeholder="" required="">
                </div>
                <div class="form-group">
                    <input type="text" name="Email" class="form-control" placeholder="Schedule" required="">
                </div>
                <div class="form-group">
                    <input type="text" name="phone" class="form-control" placeholder="Bus No." required="">
                </div>
                ...
                <div class="form-group">
                    <input type="text" name="Name" class="form-control" placeholder="Starting Time" required="">
                </div>
                <div class="form-group">
                    <input type="text" name="Name" class="form-control" placeholder="Depature Time" required="">
                </div>
