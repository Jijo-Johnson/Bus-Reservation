...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO schedule (date,schedule_no,bus_no,route_no,starting_time,destination_time) VALUES ('$date','$schedule','$busno','$routeno','$starting','$destination')";
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
				...
				<ul class="menu">
					...
					<li class="nav-item dropdown">
						...
						<a class="dropdown-item active" href="manager_add_schedule.php">Add Schedule</a>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-6">
            <form action="manager_add_schedule.php" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="routeno" class="form-control" placeholder="Route No." required="">
                </div>
                <div class="form-group">
                    <input type="text" name="starting" class="form-control" placeholder="Starting Time" required="">
                </div>
                <div class="form-group">
                    <input type="text" name="destination" class="form-control" placeholder="Destination Time" required="">
                </div>
