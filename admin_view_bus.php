        ...
        <div class="row justify-content-md-center">
            <div class="col-md-6 staff-box" style="text-align: center;">
                ...
                <div class="form-group">
                    <input type="text" name="Name" class="form-control" placeholder="Permit Number" required="">
                </div>
                <div class="form-group">
                    <input type="email" name="Email" class="form-control" placeholder="Bus Number" required="">
                </div>
                <div class="form-group">
                    <select class="form-control" id="exampleFormControlSelect1">
                ...
                <div class="form-group form-row">
                    <select class="form-control" id="exampleFormControlSelect1" style="width: 100px;  margin-left: 5px;">
                        <option>KL</option>
                        <option>TN</option>
                        <option>KA</option>
                        
                      </select>
                      <input class="form-control" type="text" placeholder="15" readonly style="width: 50px; margin-left: 10px;">
                      <input type="email" name="Email" class="form-control" placeholder="BA" required="" style="width: 100px; margin-left: 10px;">
                      <input type="email" name="Email" class="form-control" placeholder="0001" required="" style="width: 150px; margin-left: 10px;">
                </div>				
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="No. of Seats : 50" readonly>
                </div>
